...
[l1]=soru_5Hermite(listem,listem2);
[x,xt]=geriFark(listem2,l1);
[y,yt]=ileriFark(listem2,l1);
[z,zt]=aranokta(listem2,l1);
[q,qt]=ucNokta(listem2,l1);
function [l1]=soru_5Hermite(x,z)
    l1=[];
    for i=1:length(x)
        sonuc=x(i)*cos(z(i))+x(i)*sin(z(i));
        l1(end+1)=sonuc;
    end
end
